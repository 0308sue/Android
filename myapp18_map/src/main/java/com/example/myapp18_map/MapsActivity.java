...
import com.example.myapp18_map.databinding.ActivityMapsBinding;
...
//        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        ...
        LatLng curPoint = new LatLng(35.156, 129.0595);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(curPoint,15));
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(curPoint);
        markerOptions.title("AAA map");
        markerOptions.snippet("Tel:01-1111");
